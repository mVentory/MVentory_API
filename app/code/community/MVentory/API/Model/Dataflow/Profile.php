...
class MVentory_API_Model_Dataflow_Profile extends Mage_Dataflow_Model_Profile{
  ...
  public function _parseGuiData(){
        ...
        $parsers = array(
            ...
            ///@
            'order'=>'mventory/dataflow_convert_parser_order',
        ...
        $adapters = array(
            ...
            ///@
            'order'=>'mventory/dataflow_convert_adapter_order',            
